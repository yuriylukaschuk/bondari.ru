            ...
            >
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('register')" :active="route().current('register')">
                                    Рагистрация пользователей
                                </NavLink>

                                <NavLink :href="route('razdels.list')" :active="route().current('razdels.list')">
                                    Разделы
                                </NavLink>
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        <ResponsiveNavLink
                            :href="route('razdels.list')"
                            :active="route().current('razdels.list')"
                        >
                            Dashboard
                        </ResponsiveNavLink>
                    </div>
