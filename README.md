...
2. Сайт как есть представлен в целях отобразить используемые технологии и возможности разработчика.
3. Стек разработки: Laravel 12, Vue 3, Inertia
4. Некоторые миграции не переделывались, исправления велись в самой базе данных. Актуальная версия базы bondari.sql данных расположена в каталоге /database
